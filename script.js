...
const PREDEFINED_KEYWORDS = {
    "流体・熱・エネルギー": {
        "主要": ["流体力学",  "熱流体", "伝熱","数値流体力学", "エネルギー効率化"],
        "専門・詳細": ["ナビエ・ストークス方程式", "無次元化", "層流", "乱流", "低レイノルズ数", "高レイノルズ数流れ", "流れの遷移", "複雑な流れ現象", "亜音速", "圧縮性流体", "粘弾性流体", "境界層", "気液混相流", "沸騰現象", "表面張力", "濡れ現象", "マランゴニ対流", "マイクロ流路", "プラントのガス漏洩検知", "有害物質拡散源推定", "熱交換器性能最適化"]
    },
    "航空・宇宙": {
        "主要": ["航空機", "航空機設計", "宇宙環境", "エンジン設計", "羽ばたき飛行"],
        "専門・詳細": ["航空機翼", "翼の最適化設計", "風洞実験", "離陸飛行実験", "JAXA", "ターボジェットエンジン", "極超音速エンジン", "複合サイクルエンジン", "スペースプレーン", "エンジン制御", "流路切替機構設計", "火星飛行探索機", "生命維持", "水電解"]
    },
    "材料・構造・固体力学": {
        "主要": ["材料力学", "複合材料", "炭素繊維・連続繊維", "破壊力学", "材料強度学・強度評価", "微細加工"],
        "専門・詳細": ["連続体力学", "弾塑性力学", "損傷力学", "非線形破壊力学", "計算固体力学", "計算破壊力学", "疲労・繰り返し荷重", "セラミックス", "溶接き裂", "ダイヤモンド半導体", "亀裂進展解析", "J積分", "引張試験", "曲げ試験", "衝撃強度試験", "DCB試験(層間破壊靭性試験)", "破面観察", "走査電子顕微鏡", "知的材料・構造", "リサイクルCFRP", "CFRP", "GFRP", "ボイド", "含侵", "VARTM(樹脂注入成形)", "フラン樹脂", "成膜", "集積回路と銅メッキ", "白金触媒", "プラズマ照射", "固体力学解析手法構築", "分子動力学", "転位動力学", "フィラメント"]
    },
    "ロボティクス・制御・機械要素": {
        "主要": ["振動工学", "音響シミュレーション", "ロボット工学", "産業用ロボット", "ドローン", "自動車への応用", "自動化"],
        "専門・詳細": ["ロボット視覚機能付与", "協働ロボット(UR等)", "ロボットアーム", "ロボットマニピュレーション", "ロボット制御", "センサ", "人工筋肉", "モーションキャプチャ", "小型ロボットヘリコプター", "マイクロ航空機", "自立飛行", "飛行制御", "ロバスト制御", "機械機構・ロボット設計", "ロボットビジョン", "ビジュアルサーボ", "電子工作", "MEMS", "レーザー加工", "流量計開発・評価", "警告音設計(自転車等)"]
    },
    "解析・シミュレーション・情報": {
        "主要": ["プログラミング", "人工知能", "機械学習", "画像解析", "数値解析", "有限要素法"],
        "専門・詳細": ["python", "c言語", "CAE", "分子シミュレーション", "IGA(アイソジオメトリック解析)", "FPM(粒子法)", "重合メッシュ法", "領域積分法", "サンプリングモアレ法", "marc(非線形構造解析ソフト)", "フーリエ解析", "テンソル解析", "統計解析", "情報理論・データサイエンス", "最適化", "フィジカルAI", "深層学習・CNN", "強化学習", "画像処理・物体認識", "点群処理", "fortran", "MATLAB", "Simulink", "サウンドスケープ評価", "粒子法"]
    },
    "生体・医療・バイオメカニクス": {
        "主要": ["バイオメカニクス", "医療工学", "生体工学", "医療・福祉支援技術", "介護支援", "感性工学", "生物模倣"],
        "専門・詳細": ["生体機械", "聴覚・音声メカニズム", "アクティブマター・自己駆動粒子", "感覚提示技術", "血栓解析", "血流・血管の解析", "人工心臓・人工弁", "内視鏡", "がん細胞", "脳波解析(睡眠・音楽)", "嚥下(えんげ)音解析", "聴力評価(DINテスト)", "病院の音環境"]
    },
    "設備・実験手法・その他ツール": {
        "主要": ["設計", "3Dプリンタ"],
        "専門・詳細": ["ナノテラス", "ハイスピードカメラ", "VR音響評価", "電子顕微鏡", "マイクロスコープ", "真空装置", "着磁", "三次元計測", "フォトリソグラフィー", "電気化学", "小型燃料電池", "ROS", "Fusion", "Claude", "Notion", "快適性評価(well-being)", "プラント安全設計"]
    }
};
